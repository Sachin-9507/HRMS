...
import EmployeeList
  from "../pages/admin/employees/EmployeeList";

import EmployeeCreate
  from "../pages/admin/employees/EmployeeCreate";

import EmployeeEdit
  from "../pages/admin/employees/EmployeeEdit";

import UserList
  from "../pages/admin/users/UserList";

import UserCreate
  from "../pages/admin/users/UserCreate";

import UserEdit
  from "../pages/admin/users/UserEdit";

import RoleList
  from "../pages/admin/roles/RoleList";

import RoleEdit
  from "../pages/admin/roles/RoleEdit";

import PermissionList
  from "../pages/admin/permissions/PermissionList";

import AttendanceList
  from "../pages/admin/attendance/AttendanceList";

import AttendanceEdit
  from "../pages/admin/attendance/AttendanceEdit";

import LeaveList
  from "../pages/admin/leaves/LeaveList";

import LeaveReview
  from "../pages/admin/leaves/LeaveReview";

import AuditLogList
  from "../pages/admin/audit/AuditLogList";
